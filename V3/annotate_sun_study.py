"""
Legenda 2D para as 10 imagens de V3/renders/sol_*.png (gerado por
render_v3_sol.py) — mesma lógica de V6/annotate_sun_study.py, apontando
para V3/renders.
...
for cena in meta["cenas"]:
    ...
    lines = [
        "Quiosque com fundo p/ casa da mae",
        estacao_label,
