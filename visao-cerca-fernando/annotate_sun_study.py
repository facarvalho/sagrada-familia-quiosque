...
render_sol.py) — mesma lógica de renders/scripts/annotate_sun_study.py, só apontando
...
for cena in meta["cenas"]:
    ...
    lines = [
        "Quiosque com fundo p/ cerca do Fernando",
        estacao_label,
...
print("ALLDONE_ANNOTATE_SUN_CERCA_FERNANDO")
