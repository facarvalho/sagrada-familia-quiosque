...
from documentacao.pdf_lib import PDFDoc, wrap_text, text_width, PAGE_W, PAGE_H

BASE = "/home/fac/piscina/renders"
OUT_DIR = "/home/fac/piscina/documentacao"
...
hero_w, hero_h = p.fit_image(f"{BASE}/projeto_render.png", MARGIN, hero_y, PAGE_W - 2 * MARGIN, P(560))
...
_hero = f"{BASE}/projeto_render.png"
...
plan_w, plan_h = p.fit_image(f"{BASE}/planta_quiosque_anotada.png", MARGIN, img_y, PAGE_W - 2 * MARGIN, PAGE_H - img_y - P(60))
plan_x = MARGIN
...
gallery = [
    ...
    ("Rede hidrossanitária - água fria, esgoto e represa", "esgoto_quiosque_medidas.png"),
...
out_path = f"{OUT_DIR}/Caderno_de_Obra.pdf"
doc.save(out_path)
