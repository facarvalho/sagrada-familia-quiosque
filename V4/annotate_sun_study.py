"""
Legenda 2D para as 10 imagens de V4/renders/sol_*.png (gerado por
render_v4_sol.py) — mesma lógica de V6/annotate_sun_study.py, apontando
para V4/renders.

Roda com python3 puro (sem Blender): python3 V4/annotate_sun_study.py
"""
import json
import os
