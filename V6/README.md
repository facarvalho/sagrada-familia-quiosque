...
inverno) — diferente de V3/V4/V5, que usam um azimute/elevação solar
...
`V6/renders/sol_{estacao}_{h}h.png`, com legenda (`_anotado.png`) via
...
python3 V6/annotate_sun_study.py
```
