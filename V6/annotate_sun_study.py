"""
Legenda 2D para as 6 imagens de V6/renders/sol_*.png (gerado por
render_v6_sol.py) — mesma lógica de V1/annotate_sun_study.py, só apontando
para V6/renders.

Roda com python3 puro (sem Blender): python3 V6/annotate_sun_study.py
"""
import json
import os
...
for cena in meta["cenas"]:
    ...
    lines = [
        "V6 - quiosque na quina SUDESTE da laje" ,
        estacao_label,
