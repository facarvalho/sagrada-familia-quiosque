...
BASE_DIR = "/home/fac/piscina/renders"
img = Image.open(f"{BASE_DIR}/planta_quiosque_base.png").convert("RGB")
draw = ImageDraw.Draw(img, "RGBA")

with open(f"{BASE_DIR}/planta_quiosque.json", "r", encoding="utf-8") as f:
    data = json.load(f)
...
out_path = f"{BASE_DIR}/planta_quiosque_anotada.png"
img.save(out_path)
