...
img = Image.open(f"{BASE_DIR}/projeto_render_base.png").convert("RGB")
draw = ImageDraw.Draw(img, "RGBA")

with open(f"{BASE_DIR}/labels.json", "r", encoding="utf-8") as f:
    data = json.load(f)
...
out_path = f"{BASE_DIR}/projeto_render_anotado.png"
img.save(out_path)
