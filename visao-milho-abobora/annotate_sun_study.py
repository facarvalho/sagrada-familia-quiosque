"""
Legenda 2D para as 10 imagens de visao-milho-abobora/renders/sol_*.png (gerado por
render_v4_sol.py) — mesma lógica de visao-cerca-fernando/annotate_sun_study.py, apontando
para visao-milho-abobora/renders.

Roda com python3 puro (sem Blender): python3 visao-milho-abobora/annotate_sun_study.py
"""
import json
import os
...
for cena in meta["cenas"]:
    ...
    lines = [
        "Quiosque com fundo p/ milho/abobora",
        estacao_label,
    ...
    for i, ln in enumerate(lines):
        font = FONT_BOLD if i in (0, 1) else FONT_REG
