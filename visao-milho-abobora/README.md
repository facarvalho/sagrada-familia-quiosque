...
do projeto com a mesma calibração de `nucleo/sun_geo.py` (âncora P1/P9,
...
`visao-milho-abobora/render_v4_sol.py` agora só chama `nucleo/variant_sol_common.py`
...
3. Adiciona o entorno real — cerca, café e terreno
   (`arquitetonico/contexto_externo.py`, dados do projeto de fibra óptica
...
Saídas em `visao-milho-abobora/renders/sol_{estacao}_{h}h.png`, com legenda
(`_anotado.png`) via `visao-milho-abobora/annotate_sun_study.py`.
...
python3 visao-milho-abobora/annotate_sun_study.py
```
