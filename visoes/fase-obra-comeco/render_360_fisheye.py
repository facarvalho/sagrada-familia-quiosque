"""
Panorâmica 360° olho de peixe, no meio do corredor principal - versão
"esqueleto" de renders/scripts/render_360_fisheye.py, sem paredes/banheiro/móveis: só
piso, pilares, vigas, terças e telhado.
"""
import bpy
import os
import sys
...
out_path = os.path.join(renders_dir, "vista_360_fisheye_comeco.png")
