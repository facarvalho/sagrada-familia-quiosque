...
NÃO monta (ao contrário de arquitetonico/extras.py): paredes (wall.py/bathroom.py),
...
Os render_*.py desta pasta (visoes/fase-obra-comeco/) chamam build() no lugar de
V1.extras.build_all.
"""
import os
import sys
