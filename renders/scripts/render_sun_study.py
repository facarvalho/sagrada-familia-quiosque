...
geográficas do terreno (nucleo/cordenadas.kml -> nucleo/sun_geo.py).
...
Uso (bootstrap obrigatório, ver memória piscina-render-import-bootstrap):
  ...
  $BL --background --factory-startup \
      ...
      --python renders/scripts/render_sun_study.py
"""
import bpy
import os
import sys
...
# ---------------------------------------------------------------------------
projeto_path = "/home/fac/piscina/arquitetonico/projeto.py"
...
out_dir = os.path.join(scriptdir, "..")
