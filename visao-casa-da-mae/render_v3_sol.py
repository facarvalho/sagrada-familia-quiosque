...
do projeto com a mesma calibração de V1/sun_geo.py (âncora P1/P9, rotação
133,7°) -> (-8,0318 ; -7,9191).
...
Inclui o entorno real (cerca/café/terreno, V1/contexto_externo.py) e a
prova de sol real (NOAA, V1/sun_geo.py) às 15h/16h/17h/18h/19h, verão e
inverno.
